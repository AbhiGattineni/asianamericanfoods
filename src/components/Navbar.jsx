        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              <h2 className={`font-display font-bold text-lg transition-colors ${
            ...
            <button 
              ...
              className={`px-6 py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105 ${
                isScrolled
                  ...
                  : 'bg-primary-600 hover:bg-primary-700 text-white shadow-md hover:shadow-lg' // Consistent button style
              }`}
            >
              Order Now
            </button>
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="py-4 space-y-2 bg-white/95 backdrop-blur-md rounded-b-lg mt-2 shadow-lg">
            ...
            <div className="px-2 pt-2">
              <button 
                onClick={(e) => handleScroll(e, '#contact')}
                className="w-full bg-primary-600 hover:bg-primary-700 text-white py-3 px-4 rounded-full font-medium transition-colors"
              >
                Order Now
              </button>
            </div>
